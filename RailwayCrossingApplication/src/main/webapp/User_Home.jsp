		...
		<div class="card-body">
			...
			%>
               ...
               <%} %>
				...
				Landmark: &nbsp;<b><%=rail.getLandmark()%></b><br> Address:
				&nbsp;<b><%=rail.getAddress()%></b><br>
			</p>
			
			<form action="FavCrossingDao" method="post">
			<input type="hidden" name="id" value="<%=rail.getCrossingId()%>">
			<input type="submit" class="btn btn-outline-dark bg-light text-secondary" value="ADD TO FAVOURITE" >
			</form>
		</div>
	</div>
